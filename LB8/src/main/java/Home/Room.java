...
public class Room implements java.io.Serializable{
    ...
    public Room(String name, int countOfSocket){
        ...
        if(countOfSocket < 0){
            System.out.println("кількість розеток повинна бути >= 0\nВстановлено автоматичне значення 0");
    ...
    public String toString() {
        return "Кімната{" +
                "\nІм'я='" + name + '\'' +
                "\nКількість розеток=" + countOfSocket +
                 "\nКількість пристроїв=" + appliances.size() +
                "\nКількість ввімкнених в розетку пристроїв="+pluggedAppliances.size()+
                "\n}";
    }
